  ...
  return (
    <section className="container mx-auto my-10 px-4 flex justify-between items-center">
      <h3 className="text-2xl font-bold text-[#131313]">
        {isAvailablePlayersToggled ? "Available Players" : "Selected Players"}
      </h3>
      <div>
        <button
        ...
        <button
          ...
          className={`border border-[#1313131a] border-l-0 rounded-r-xl px-8 py-2 text-base ${isAvailablePlayersToggled === false ? "font-bold text-[#131313] bg-[#E7FE29] shadow-md" : "font-normal text-[#13131399]"} cursor-pointer active:scale-95 active:translate-y-0.5`}
        >
