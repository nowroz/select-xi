  ...
  return (
    <section className="container mx-auto my-10 px-4">
      ...
      <div
        ...
        className="flex justify-end sm:px-4"
      >
        <button className="my-10 bg-[#E7FE29] rounded-xl outline-1 outline-offset-6 outline-[#131313] shadow-md px-5 py-3 text-xs sm:text-base font-bold text-[#131313] cursor-pointer active:scale-95 active:shadow-none active:outline-none">
